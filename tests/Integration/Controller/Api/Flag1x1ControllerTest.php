...
class Flag1x1ControllerTest extends KernelTestCase
{
    ...
    {
        $this->assertTrue(class_exists(Flag1x1Controller::class));
    }
    ...
    public function test_controllerCanBeInstantiated(): void
    {
        ...
        $controller = new Flag1x1Controller($flagService);
        $this->assertInstanceOf(Flag1x1Controller::class, $controller);
    }
    ...
    public function test_invoke_returnsBinaryFileResponse_whenFlagExists(): void
    {
        ...
        if ($flagService->flagExists('cn', '1x1')) {
            $controller = new Flag1x1Controller($flagService);
            ...
            $this->markTestSkipped('No 1x1 flags available for testing');
        }
    }
    ...
    {
        $container = static::getContainer();
        $this->assertTrue($container->has(Flag1x1Controller::class));
        
        $controller = $container->get(Flag1x1Controller::class);
        $this->assertInstanceOf(Flag1x1Controller::class, $controller);
    }
}